...
export const ContainerStyled = styled.div`
  ...
  background-image: image-set(url(${bgMob}) 1x, url(${bgMob}) 2x);

  @media screen and (min-width: 768px) {
    background-image: image-set(url(${bgTab}) 1x, url(${bgTab}) 2x);
    padding: 40px 32px 44px;
  }

  @media screen and (min-width: 1440px) {
    background-image: image-set(url(${bgDesktop}) 1x, url(${bgDesktop}) 2x);
